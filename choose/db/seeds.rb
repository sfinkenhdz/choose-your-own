...
The FIGHTERS have decided to tackle to the Dalek threat head on. They are very smart, and very full of themselves. They are developing weapons and traps that exploit the few Dalek weaknesses to create a full system of attack. They are having success, but there is a lot of competition and in-fighting.

The BUILDERS are thinking about protection from the Daleks, extreme weather, and other threats. They are very creative, and have built a wide variety of shelter out of anything they can find. It works, but quality varies greatly. So far they have found enough food in the ruins to survive, but this will soon run out.

The SLACKERS appear to be doing, well, not much of anything. They are camped out by a river and don't seem to have much of a plan. The land near the river grows various berry bushes and other edible plants. The group seems to be doing all right for now, and don't seem too interested in a longer-term plan.

The CHOMPERS have food figured out. They scavenged food from the wreckage, but rather than eating all of it directly, they have been using it primarily as bait to lure various types of small game. (Who knew squirrels had such a love of Skittles and SweetTarts?) They have also explored a much larger area than the other groups and have found various clusters of edibles that can be foraged. They're cautious, but welcoming.

Now, for our first decision: Shall we make a plan, or start by visiting the group closest to us?", visited?: 0 },
...
When we arrive everyone wants to tell us about their inventions. We begin to realize that most of their ideas are great, but have different pros and cons. Unfortunately, they have all been too busy bragging to listen to each other. And, they don't have a good way to measure relative benefits or keep track of what works best in different situations.

'There should be an app for this,' you say.

It's too bad that the meteor shower's destruction has left the world without electricity. An algorithmic program backed by databases of information about the weapons and possible use scenarios would really help this group maximize what they are doing.
...
Should we tell them how great they are, or tell them they aren't as smart as they think they are?", visited?: 0 },
  { name: 'Go to builders', text: "After a short walk, we arrive at a patchwork of makeshift homes. All provide basic protection from the elements and at least some barrier to fend off attacking creatues.

However, a lack of long-term planning is evident. The dwellings built first are far superior and some have redundant features using materials that would have been better saved for homes built later on. They have gathered piles of similar materials, but they are in no logical order so builders just wander around asking and looking for what they need.
...
So, we have a pretty easy decision to make.  Should we invite them to cooperate in the great re-building of humanity, or should we throw rocks at them?", visited?: 0 },
  { name: 'Choose: leave/apologize', text: "Should we go, or apologize?", visited?: 0 },
  { name: 'Go to chompers', visited?: 0, text: "Now that we have succeeded with this group, on to the next! Next, we go visit the Chompers.

    As we near the group, we pass a chomper child gathering firewood to bring back. Should we take the time to stop to help?" },
...
xxx Even though no computers, we were able to use programming concepts to make things better. It's a language. xxx
...
You can contact me at: sarah.finken@gmail.com or 773-726-9405.", visited?: 0 },
  { name: 'Success with builders', text: "Not surprisingly, this hungry, collaborative group is more than happy to join our efforts.

But before we leave we decide to help them with their haphazard process for grouping and using materials.
...
'Exactly. They are basically building, repairing or destroying and they need materials and tools to work on roofs, walls, floors or fences.'

We suggest the center of their settlement as something of a router, where building requests are directed. From there, we create different paths, depending upon whether people need materials to build roofs, walls, floors or fences and then whether they will be building, repairing or destroying that part of the dwelling.
...
This group is very organized and detail-oriented, so they also appreciate that we considered the variety of wood needed.
...
We explain source control and help them segment off small numbers of their plants to create various branches that they can experiment on, and then merge back into their master crop when they are sure that branch is an improvement they want to keep, and is free of bugs and other pests.
...
They give us the choice of doing trust falls or manual labor.", visited?: 0 },
  { name: "Gain trust of chompers 2" , text: "For whatever reason, this act has been enough to gain the trust of the group. They now feel that we have proven our sincerity, and agree to cooperate.
...
Should we go to the caves or the river?", visited?: 0 },
  { name: "Arrive at final group", text: "We arrive at the caves, and find the people we are looking for. They are more than happy to show us around. It quickly becomes evident that the Slackers are anything but lazy.

As they explain what they've been up to, it becomes clear that the this group is actually an excellent team. They have been working hard, communicating consistently, and took the time to assess what they needed, resources available, and each person's strengths and weaknesses. Because they have been working so well together, they haven't appeared quite as stressed out as the other groups, and have even been having some fun.

Twice each day, the group meets quickly to review what they are working on, what they've learned, what they're doing next, and any challenges that they are having. In between meetings, they have created a messaging system that involves flying different colors of flags high enough to be seen by the entire group. It's sort of like the post-apocolyptic version of Slack, which is actually where the group got their name.
...
They have been considering reaching out to other groups, so are happy to join our efforts. We are happy to have them on board and impressed that they are working so well together thanks to agile methodologies and good teamwork.
...
choices = Choice.create([
  ...
  {name: 'Easiest', text: "In some situations, I like to start with the most difficult task, because when solving a problem, I like to get a feel for the most challenging parts early on.
